...
import { AiDraftProgress } from './ai-draft-progress';
    ...
    return (
        <>
            <Modal
                ...
                onClose={mutation.isPending ? () => { /* lock close while drafting */ } : handleClose}
                title={mutation.isPending ? 'Drafting your meal plan' : 'AI Meal Plan Draft'}
                size="lg"
                showCloseButton={!mutation.isPending}
            >
                {mutation.isPending ? (
                    <AiDraftProgress startedAt={startedAtRef.current || Date.now()} />
                ) : (
